...
export default function Menu() {
  ...
  return (
    <div className="px-12 py-[100px] max-w-[1280px] mx-auto" id="menu">
      <div className="text-center mb-[60px]">
        <div className="text-[11px] tracking-[4px] uppercase text-accent mb-3">The Menu</div>
        <h2 className="text-[36px] font-extrabold tracking-[-0.5px]">
          Combos, nigiri &amp; <span className="text-accent italic font-light">everything in between</span>
        </h2>
      </div>
            ...
            <button
              ...
              className={`px-5 py-2 rounded-[20px] text-[13px] font-semibold cursor-pointer border transition-all ${
                active
                  ...
                  : 'bg-transparent border-border text-muted hover:bg-accent hover:text-black hover:border-accent'
              }`}
            >
              {c.label}
            </button>
